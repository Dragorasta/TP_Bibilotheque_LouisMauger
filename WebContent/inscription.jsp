...
<div class="wrapper">
	...
	<form method="post" action="InscriptionServlet">
		...
		ID <input name="idUser" required/><br/>
		NOM <input name="nomUser" required/><br/>
	    PRENOM <input name="prenomUser" required/><br/>
	    MAIL <input name="mailUser" required/><br/>
	    MOT DE PASSE <input name="motDePasseUser" required/>
	    <br/>
