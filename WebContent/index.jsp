...
<body>
 ...
 <div class="wrapper">
	<div class="container">
		...
		<form class="form" method="post" action="ShowAllOuvrages">
			<button type="submit" id="login-button">Voir nos livres</button>
		</form>
		<form class="form" method="post" action="ShowAllUtilisateurs">
			<button type="submit" id="login-button">Voir nos adhérents</button>
		</form>
	</div>
